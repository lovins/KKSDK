package com.tapque.inneractive;
...
public class InneractiveBannerForMopub extends CustomEventBanner {
  ...
  private static String SAMPLE_BANNER_SPOT_ID = ""; //for example, inneractive's spot id for testing: "150942"
  ...
  protected void loadBanner(final Context context,
    ...
    if (localExtras != null) {
      ...
      if (localExtras.containsKey(InneractiveMediationDefs.KEY_KEYWORDS) && TextUtils
          .isEmpty(resultKeywords)) {
    ...
    mBannerSpot.setRequestListener(new InneractiveAdSpot.RequestListener() {
      ...
      public void onInneractiveFailedAdRequest(InneractiveAdSpot adSpot,
        ...
        Log.d(InneractiveMediationDefs.INNERACTIVE_MEDIATION_SAMPLE_APP_TAG,
            InneractiveMediationDefs.IA_LOG_FOR_MOPUB_BANNER
                + " - inneractiveBannerFailed with Error: " + errorCode);
